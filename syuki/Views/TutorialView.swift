...
struct TutorialView: View {
    ...
    let tutorialPages = [
        TutorialPage(image: "tutorial1", title: "ようこそ！weekの世界へ", description: "weekを使えば、「気づいたら一週間経ってた」がなくなります。"),
        ...
        TutorialPage(image: "tutorial5", title: "いい生活は、いい一週間から。", description: "Syukiと共に、意識的な1週間を過ごしましょう。")
    ]
